...
module.exports = (htmlFile, cssFile, options = { inky: { enabled: true }, juice: { linkCss: false, nofetch: false } }) => {
    return new Promise((resolve, reject) => {
        ...
        if (options.juice.linkCss) {
            if (options.juice.nofetch) {
                htmlResult = Juice(options.inky.enabled ? convertedHtml : htmlFile, options.juice);
